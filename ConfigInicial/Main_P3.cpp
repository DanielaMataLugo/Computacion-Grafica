//Práctica 03
//Daniela Mata Lugo
//Fecha de entrega: 31 agosto 2025
...
int main() {
 ...
 //     
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		view = glm::translate(view, glm::vec3(1.5f, 0.0f, -15.0f));

		model = glm::translate(model, glm::vec3(0.0f, -2.5f, 0.0f));
		model = glm::rotate(model, glm::radians(180.0f), glm::vec3(0.0f, 0.1f, 0.1f)); // use to compare orthographic and perspective projection
		model = glm::scale(model, glm::vec3(3.0f, 3.0f, 3.0f));
		//view = glm::translate( view, glm::vec3( screenWidth / 2, screenHeight / 2.8,-700.0f ) ); // use with orthographic projection
		...
		model = glm::mat4(1);
		model = glm::translate(model, glm::vec3(-2.9f, -2.5f, 0.0f));
		...
		model = glm::mat4(1);
		model = glm::translate(model, glm::vec3(-5.8f, -2.5f, 0.0f));
		model = glm::rotate(model, glm::radians(180.0f), glm::vec3(1.0f, 0.0f, 0.0f)); // use to compare orthographic and perspective projection
		model = glm::scale(model, glm::vec3(3.0f, 3.0f, 3.0f));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glDrawArrays(GL_TRIANGLES, 0, 36);

		model = glm::mat4(1);
		model = glm::translate(model, glm::vec3(-2.8f, 0.3f, 0.0f));
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(0.0f, 1.0f, 0.0f)); // use to compare orthographic and perspective projection
		...
		model = glm::rotate(model, glm::radians(270.0f), glm::vec3(0.0f, 1.0f, 0.0f)); // use to compare orthographic and perspective projection
		model = glm::scale(model, glm::vec3(2.7f));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glDrawArrays(GL_TRIANGLES, 0, 36);

		model = glm::mat4(1);
		model = glm::translate(model, glm::vec3(-1.4f, 2.8f, 0.0f));
		model = glm::rotate(model, glm::radians(0.0f), glm::vec3(1.0f, 0.0f, 0.0f)); // use to compare orthographic and perspective projection
