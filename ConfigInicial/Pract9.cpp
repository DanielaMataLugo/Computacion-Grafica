//Práctica 09
//Daniela Mata Lugo
//Fecha de entrega: 19 octubre 2025
...
glm::vec3 pointLightPositions[] = {
	glm::vec3(-1.13f, -0.63f, 0.7f),
	glm::vec3(1.0f, -0.69f, 0.98f)
};
...
int main()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glUniform3f(glGetUniformLocation(lightingShader.Program, "pointLights[0].ambient"), 0.03f, 0.0f, 0.0f);
		glUniform3f(glGetUniformLocation(lightingShader.Program, "pointLights[0].diffuse"), 0.25f, 0.0f, 0.0f);
		glUniform3f(glGetUniformLocation(lightingShader.Program, "pointLights[0].specular"), 0.35f, 0.1f, 0.1f);
		...
		glUniform3f(glGetUniformLocation(lightingShader.Program, "pointLights[1].diffuse"), 0.70f, 0.70f, 0.70f);
		glUniform3f(glGetUniformLocation(lightingShader.Program, "pointLights[1].specular"), 0.90f, 0.90f, 0.90f);
		...
		glUniform3f(glGetUniformLocation(lightingShader.Program, "spotLight.ambient"), 0.06f, 0.05f, 0.03f);
		glUniform3f(glGetUniformLocation(lightingShader.Program, "spotLight.diffuse"), 1.00f, 0.85f, 0.40f);
		glUniform3f(glGetUniformLocation(lightingShader.Program, "spotLight.specular"), 1.00f, 0.90f, 0.60f);
		...
		model = glm::mat4(1);
		model = glm::scale(model, glm::vec3(0.08f));
		model = glm::translate(model, glm::vec3(-14.0f, -8.9f, 8.9f));
		glBlendFunc(GL_SRC_ALPHA, GL_ONE_MINUS_SRC_ALPHA);
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glUniform1i(glGetUniformLocation(lightingShader.Program, "transparency"), 0);
		...
		model = glm::mat4(1);
		model = glm::scale(model, glm::vec3(0.2f));
		model = glm::translate(model, glm::vec3(5.0f, -3.9f, 4.9f));
		glBlendFunc(GL_SRC_ALPHA, GL_ONE_MINUS_SRC_ALPHA);
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glUniform1i(glGetUniformLocation(lightingShader.Program, "transparency"), 0);
